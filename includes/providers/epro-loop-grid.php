...
class Jet_Smart_Filters_Provider_EPro_Loop_Grid extends Jet_Smart_Filters_Provider_Base {
	...
	public function __construct() {
		...
		if ( ! jet_smart_filters()->query->is_ajax_filter() ) {
			 ...
			 */
			add_filter( 'elementor/query/query_args', array( $this, 'store_default_widget_query_settings' ), 0, 2 );
		}
	}
	...
	public function store_default_widget_query_settings( $query_args, $widget ) {
		...
		*/
		foreach ( array( 'paged', 'posts_per_page', 'post_type', 'post_status', 'ignore_sticky_posts', ) as $propKey ) {
